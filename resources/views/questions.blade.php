<x-app-layout>
        ...
        <div class="content">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
                <div class="flex-grow-1">
                    <h1 class="h3 fw-bold mb-1">@lang('locale.question', ['suffix' => 's'])</h1>
                </div>
                <nav class="flex-shrink-0 mt-1 mt-sm-0 ms-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        ...
                        <li class="breadcrumb-item" aria-current="page">@lang('locale.question', ['suffix' => 's'])</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="content">
        <div class="block block-rounded">
            <div class="block-header block-header-default d-flex align-items-center justify-content-between">
                <h3 class="block-title">@lang('locale.question', ['suffix' => 's'])</h3>
                <a role="button" data-bs-toggle="modal" data-bs-target="#add-question" class="btn btn-sm btn-success">
            ...
            <div class="modal-content">
                <div class="block block-rounded block-transparent mb-0">
                    <div class="block-header block-header-default bg-success text-white">
                        <h3 class="block-title">@lang('locale.question', ['suffix'=>''])</h3>
                    ...
                    <form action="{{ route('questions.store') }}" method="POST">
                        ...
                        <div class="block-content fs-sm">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control form-control-alt" id="title" name="title" placeholder="@lang('locale.title')">
                            </div>
                            <div class="mb-4">
            ...
            <div class="modal-content">
                <div class="block block-rounded block-transparent mb-0">
                    ...
                    <form method="POST" id="edit-question-form">
                        ...
                        <div class="block-content fs-sm">
                            <div class="mb-4">
                                <label class="form-label" for="edit-question-title">@lang('locale.title')</label>
                                <input type="text" class="form-control form-control-alt" id="edit-question-title" name="title">
                            </div>
                            <div class="mb-4">
                                <label class="form-label" for="edit-question-body">@lang('locale.body') <span class="text-danger">*</span></label>
                                <textarea name="body" id="edit-question-body" cols="30" rows="5" class="form-control form-control-alt" required></textarea>
                            </div>
                        </div>
                        <div class="block-content block-content-full text-end bg-body">
    ...
    <script>
        ...
        let openEditQuestionModal = (button) => {
            const id = button.getAttribute('data-id');
            const title = button.getAttribute('data-title');
            const body = button.getAttribute('data-body');

            document.getElementById('edit-question-title').value = title;
            document.getElementById('edit-question-body').value = body;

            const form = document.getElementById('edit-question-form');
            const baseUrl = document.querySelector('meta[name="app-url"]').getAttribute('content');
            form.action = `${baseUrl}/questions/${id}`;

            const modal = document.getElementById('edit-question');

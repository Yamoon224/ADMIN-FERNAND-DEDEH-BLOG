        ...
        <div class="content">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
                <div class="flex-grow-1">
                    <h1 class="h3 fw-bold mb-1">@lang('locale.podcast', ['suffix'=>'s'])</h1>
                </div>
                <nav class="flex-shrink-0 mt-1 mt-sm-0 ms-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        ...
                        <li class="breadcrumb-item" aria-current="page">@lang('locale.podcast', ['suffix'=>'s'])</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination push">
                        ...
                        <li class="page-item {{ $podcasts->onFirstPage() ? 'disabled' : '' }}">
                            <a class="page-link" href="{{ $podcasts->previousPageUrl() ?? 'javascript:void(0)' }}" aria-label="Previous">
                        ...
                        @foreach ($podcasts->getUrlRange(1, $podcasts->lastPage()) as $page => $url)
                            <li class="page-item {{ $podcasts->currentPage() == $page ? 'active' : '' }}">
                        ...
                        <li class="page-item {{ $podcasts->hasMorePages() ? '' : 'disabled' }}">
                            <a class="page-link" href="{{ $podcasts->nextPageUrl() ?? 'javascript:void(0)' }}" aria-label="Next">
        ...
        <div class="content content-full">
            <div class="my-5 text-center">
                ...
                <h4 class="h5 fw-medium opacity-75">
                    Envie de la partager ou de t’exprimer à travers un podcast ? Clique sur le bouton ci-dessous et contribue à notre communauté passionnés !
                </h4>
